...
def update_flipside_data():
    ...
    try:
        ...
        n_fd_pages = math.ceil(hours_ago / 8) + 1
        n_pages = math.ceil(hours_ago / 4) + 1
        ...
        cols = ['id','slug','slug_id','statement','created_at','updated_at','last_successful_execution_at','user_name','user_id','name','dashboard_title','dashboard_description','dashboard_tags','dashboard_updated_at']
